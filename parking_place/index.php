    ...
    <div id="box-form">
      <div id="left-panel">
        ...
        <div class="sidebar">
          ...
          <a href="/CarGNB/TopUp/TopUp.html">
            <h3>Wallet</h3>
          </a>
          <a href="#">
            <h3>Account</h3>
      ...
      <div id="right-panel">
        <div class="right-overlay">
          ...
          <h2>Your Avaliable Parking Space</h2>
          <div class="slot">
            <div class="slot-box">
              <h1>City Park</h1>
          ...
          <h2>Your Occupied Parking Space</h2>
          <div class="slot">
            <div class="slot-box">
              <h1>City Park</h1>
          ...
          <input type="button" class="button_active" value="ADD NOW" onclick="location.href='/CarGNB/Search/index.html';" />
